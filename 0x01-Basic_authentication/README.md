...
![](https://i.pinimg.com/474x/35/51/4d/35514d21603ab8f3b963a13c2f50ed99.jpg)
## Background Context

        Basic authentication is a simple authentication scheme built into the HTTP protocol1234. It is a method for an HTTP user agent to provide a user name and password when making a request2. The client sends HTTP requests with the Authorization header that contains the word Basic word followed by a space and a base64-encoded string username:password1. If a request requires authentication, the server returns 401 (Unauthorized) and the response includes a WWW-Authenticate header, indicating the server supports Basic authentication.
